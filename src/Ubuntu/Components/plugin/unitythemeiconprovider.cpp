...
private:
    ...
    {
        // Following code duplicating Qt default image loader behaviour, see qtdeclarative source
        // for readImage static function in src/quick/util/qquickpixmapcache.cpp
        QImage image;
