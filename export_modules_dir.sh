...
export QT_QPA_PLATFORMTHEME="ubuntutouchtheme"
export QT_QPA_PLATFORM_PLUGIN_PATH=$BUILD_DIR/plugins/platformthemes
...
/sbin/initctl set-env --global QT_QPA_PLATFORMTHEME="ubuntutouchtheme"
/sbin/initctl set-env --global QT_QPA_PLATFORM_PLUGIN_PATH=$BUILD_DIR/plugins/platformthemes
