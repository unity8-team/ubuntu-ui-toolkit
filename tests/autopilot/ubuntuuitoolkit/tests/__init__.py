...
class UbuntuUiToolkitTestCase(AutopilotTestCase):
    ...
    def loadItem(self, item):
        ...
        #property of item in list itself to False. So followin check fails on 
        #Nexus 4. Commenting it for now.
    ...
    def selectItem(self, itemText):
        ...
        orientation_helper = self.getOrientationHelper()
        rot = orientation_helper.rotation
        if rot==0.0:
           if y1>h2:
              self.pointing_device.drag(w2/2, h2/2, w2/2, h2/2-(y1-h2-h1))
        elif rot==90.0:
           pass
        elif rot==180.0:
           pass
