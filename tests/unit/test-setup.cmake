list(APPEND TEST_COMPILE_DEFINITIONS
     "QT_NO_KEYWORDS"
      UBUNTU_COMPONENT_PATH=\"${TESTROOT}${QT_INSTALL_QML}/Ubuntu/Components\"
...
set_property(TEST ${TARGET} PROPERTY DEPENDS test_install )
set_property(TEST ${TARGET} PROPERTY LABELS ${TARGET} )
set_property(TEST ${TARGET} PROPERTY ENVIRONMENT
    QML_IMPORT_PATH=${TESTROOT}${QT_INSTALL_QML}
    QML2_IMPORT_PATH=${TESTROOT}${QT_INSTALL_QML}
    UBUNTU_UI_TOOLKIT_THEMES_PATH=${TESTROOT}${QT_INSTALL_QML}
